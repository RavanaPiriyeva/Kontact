...
const Navbar = () => {
  return (
    <div> <section className=" d-lg-block d-none nav-top-part" >
      <div className="container">
        <div className="row align-items-center">
          <div className="col-6 top-part-left">
          ...
          <div className="col-6 top-part-right">
            <ul className="d-flex justify-content-end align-items-center">
              ...
              <li><img src={azImg} alt="azerbaijan-flag" />
