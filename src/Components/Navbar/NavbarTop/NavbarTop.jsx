...
import azImg from '../../../assets/img/azerbaijan-flag-round-icon-256.png';
import ruImg from '../../../assets/img/russia-flag-round-icon-256.png';

const NavbarTop = () => {
    return (
        <div>
            <section className=" d-lg-block d-none nav-top-part" >
                <div className="container-fluid container-xl">
                    <div className="row align-items-center">
                        <div className="col-7 top-part-left">
                            <ul className="d-flex">
                                <li><Link to='#'>Korporativ satışlar </Link></li>
                                <li><Link to='#'>Mağazalar</Link></li>
                                <li><Link to='#'>Servislər</Link></li>
                                <li><Link to='#'>Tez-tez verilən suallar</Link></li>
                            </ul>
                        </div>
                        <div className="col-5 top-part-right">
                            <ul className="d-flex justify-content-end align-items-center">
                                <li className="month"><Link to='#'>Aylıq Ödəniş</Link></li>
                                <li className="icon d-flex">
                                    <Link to='#'>
                                        <div className="heart"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <li className="call"><Link to='#'><span>*6060</span></Link></li>
                                <li className="flag"><img src={azImg} alt="azerbaijan-flag" />
                                    <img src={ruImg} alt="russia-flag" />
                                </li>
                            </ul>
                        </div>
